...
terminal_dict_filename = './pickle_data/terminal_dict_50k_PY.pickle'
...
# target_filename = './pickle_data/PY_terminal_1k_whole.pickle'
target_filename = './pickle_data/PY_terminal_50k_whole.pickle'
